...
for targetMol in molInputList:
    ...
    MCSresult = rdFMCS.FindMCS(molList, ringMatchesRingOnly=True, matchValences=True, completeRingsOnly=True, timeout=timeoutTime, bondCompare=rdFMCS.BondCompare.CompareOrderExact, maximizeBonds=False)
